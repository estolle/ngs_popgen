...
#ls /home/estolle/scratch/invpop/data/*/*.xz | rev | cut -d"." -f2- | rev


CPUs=40
ls /home/estolle/scratch/invpop/data/*/*.fastq | parallel -j1 "pigz -7 --processes $CPUs --stdout {} > {}.gz; echo {}"
ls /home/estolle/scratch/invpop/data/*/*.xz | rev | cut -d"." -f2- | rev | parallel -j1 "xz -d -T $CPUs --stdout {}.xz | pigz -7 --processes $CPUs --stdout > {}.gz; echo {}.xz"

ls /home/estolle/scratch/invpop/data/*/*.xz | rev | cut -d"." -f2- | rev | parallel -j1 "echo {}; rm -f {}.xz"
ls /home/estolle/scratch/invpop/data/*/*.fastq | parallel -j1 "echo {}; rm -f {}.fastq"



INPUTFOLDER="$HOME/scratch/home/ek/data/apis/reads"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/apis/compressed_reads"
...
INPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/reads/Melipona1_349843"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona1_349843"
mkdir -p $OUTPUTFOLDER
...
INPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/reads/Melipona1_336856"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona1_336856"
mkdir -p $OUTPUTFOLDER
...
INPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/reads/Melipona1_347805"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona1_347805"
mkdir -p $OUTPUTFOLDER
...
INPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/reads/Melipona2_330052"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona2_330052"
mkdir -p $OUTPUTFOLDER
...
INPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/reads/Melipona2_336857"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona2_336857"
mkdir -p $OUTPUTFOLDER
...
INPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/reads/Melipona2_336858"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona2_336858"
mkdir -p $OUTPUTFOLDER
...
INPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/reads/Melipona2_347806"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona2_347806"
mkdir -p $OUTPUTFOLDER
...
INPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/reads/Melipona2_349844"
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona2_349844"
mkdir -p $OUTPUTFOLDER
...
OUTPUTFOLDER="/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona_362009"
mkdir -p $OUTPUTFOLDER
...
#~ ❯❯❯ size $INPUTFOLDER
#61G	/home/es/scratch/home/ek/data/melipona/data/reads/Melipona1_336855
#~ ❯❯❯ size $OUTPUTFOLDER
#36G	/home/es/scratch/home/ek/data/melipona/data/compressed_reads/Melipona1_336855
...
INPUTFILE1="WTCHG_336855_005_1.fastq"
INPUTFILE2="WTCHG_336855_005_2.fastq"


gunzip -k $INPUTFILE1.gz
gunzip -k $INPUTFILE2.gz
