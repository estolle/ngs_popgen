#Rscript
#inputfile <- "/scratch/scratchspace/QMUL_apocrita_temp_copy/kmc/Sol_Mir6-25-bigB-p_clade2_709505-batch1.R2.kmc.count.txt"
...
png(paste(inputfile,".smallvalue_genomesize.png",sep=""),width = 1500, height = 1500)
...
write.table(new.df, file = paste0(inputfile,".small_value.summary.txt"), sep='\t', row.names=FALSE, col.names=FALSE)
print("done")
