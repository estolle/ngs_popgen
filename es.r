...
theme_es <- function(grid=TRUE, legend.position=NA, base_family='DejaVu Sans', highlight_family='DejaVu Sans') {
  ...
  th <- th + theme(plot.title = element_text(family="DejaVu Sans",face='bold'),
                   plot.subtitle = element_text(margin=margin(b=15), family="DejaVu Sans",face='semibold'),
                   plot.caption = element_text(family="DejaVu Sans",face='italic', size=10))
